...
const EMERGENCY_TYPES = [
  { key: 'medical', label: 'Medical', color: EMERGENCY_TYPE_COLORS.medical },
  { key: 'fire', label: 'Fire', color: EMERGENCY_TYPE_COLORS.fire },
  { key: 'accident', label: 'Accident', color: EMERGENCY_TYPE_COLORS.accident },
  { key: 'security', label: 'Security', color: EMERGENCY_TYPE_COLORS.security },
  { key: 'gbv', label: 'GBV', color: EMERGENCY_TYPE_COLORS.gbv },
  { key: 'mental_health', label: 'Mental Health', color: EMERGENCY_TYPE_COLORS.mental_health },
  { key: 'property_damage', label: 'Property Damage', color: EMERGENCY_TYPE_COLORS.property_damage },
  { key: 'other', label: 'Other', color: EMERGENCY_TYPE_COLORS.other }
]
        ...
        {visibleTypes.map((t) => (
          ...
          >
            <View style={[styles.typeEmojiBadge, { backgroundColor: `${t.color}26` }, selectedType === t.key && { shadowColor: t.color, shadowOpacity: 1, shadowRadius: 4, elevation: 3 }]}>
              <EmergencyTypeIcon type={t.key} color={t.color} size={30} />
            </View>
...
const styles = StyleSheet.create({
  ...
  typeEmojiBadge: { width: 52, height: 52, borderRadius: 26, alignItems: 'center', justifyContent: 'center', marginBottom: 4 },
